      ...
      axios
        ...
        .then(function (response) {
          if (response.data.status == 'lackcolumns') {
            self.message =
              'Table not detected, or there is no columns in table';
            self.showAlert();
    ...
    createPostDataForStore() {
      ...
      for (let i = 0; i < self.receiveFormFields.length; i++) {
        if (self.receiveFormFields[i].columnName != 'id') {
          result[self.receiveFormFields[i].columnName + '_name'] =
            self.receiveFormFields[i].visibleName;
          result[self.receiveFormFields[i].columnName + '_field_type'] =
            self.receiveFormFields[i].type;
          result[self.receiveFormFields[i].columnName + '_relation_table'] =
            self.receiveFormFields[i].relationTable;
          result[self.receiveFormFields[i].columnName + '_relation_column'] =
            self.receiveFormFields[i].relationColumn;
          result[self.receiveFormFields[i].columnName + '_browse'] =
            self.receiveFormFields[i].browse;
          result[self.receiveFormFields[i].columnName + '_read'] =
            self.receiveFormFields[i].read;
          result[self.receiveFormFields[i].columnName + '_edit'] =
            self.receiveFormFields[i].edit;
          result[self.receiveFormFields[i].columnName + '_add'] =
            self.receiveFormFields[i].add;
        }
      }
