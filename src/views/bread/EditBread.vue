    ...
    createPostDataForUpdate() {
      ...
      for (let i = 0; i < self.receiveFormFields.length; i++) {
        if (self.receiveFormFields[i].column_name != 'id') {
          result[self.receiveFormFields[i].id + '_name'] =
            self.receiveFormFields[i].name;
          result[self.receiveFormFields[i].id + '_field_type'] =
            self.receiveFormFields[i].type;
          result[self.receiveFormFields[i].id + '_relation_table'] =
            self.receiveFormFields[i].relation_table;
          result[self.receiveFormFields[i].id + '_relation_column'] =
            self.receiveFormFields[i].relation_column;
          if (self.receiveFormFields[i].browse == true) {
            result[self.receiveFormFields[i].id + '_browse'] =
              self.receiveFormFields[i].browse;
          }
          if (self.receiveFormFields[i].read == true) {
            result[self.receiveFormFields[i].id + '_read'] =
              self.receiveFormFields[i].read;
          }
          if (self.receiveFormFields[i].edit == true) {
            result[self.receiveFormFields[i].id + '_edit'] =
              self.receiveFormFields[i].edit;
          }
          if (self.receiveFormFields[i].add == true) {
            result[self.receiveFormFields[i].id + '_add'] =
